...
<body>
  <div class="container">
    ...
    <h3>🔌 شماتیک مدار</h3>
    <img src="./Circuit%20new.png" alt="شماتیک مدار">
    <h3>📦 تصویر نهایی پروژه مونتاژ شده</h3>
    <img src="./final.jpg" alt="پروژه نهایی">
    ...
    <h2>🧠 توسعه‌دهنده</h2>
    <p>
      <strong>رضا احمدی</strong><br>
      دانشجوی کارشناسی ارشد مهندسی برق – گرایش الکترونیک دیجیتال<br>
      دانشگاه افرش<br>
